...
namespace ContosoUniversityModelBinding.BLL
{
    public class SchoolBL : IDisposable
    {
        ...
        public IQueryable<ContosoUniversityModelBinding.Models.Student> GetStudents([Control] AcademicYear? displayYear)
        {
        ...
        {
            var item = new ContosoUniversityModelBinding.Models.Student { StudentID = studentID };
